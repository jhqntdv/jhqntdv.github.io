...
description: ASC718 Technical Guide
pin: false
math: true
---
...
The dynamics of the underlying equity can be expressed in the mathematical form of:
$$
\begin{equation}
...
\mu      & : \text{ expected growth rate (typically risk-free rate (rfr) used under risk-neutral measure)} \\
...
W_t      & : \text{ random variable that follows a normal distribution, } W_t \sim \mathcal{N}(0, t) \\
\end{aligned}
